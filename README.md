...
You can find below an architecture diagram of a sample Karamada based EKS Cluster architecture with parent and managed clusters and its centralized containerized application deployment process to those clusters. 
