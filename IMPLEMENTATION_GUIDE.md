...
Create an AWS Cloud9 instance that resides in the same VPC you created for the purposes of this project. Open that AWS Cloud9 instance and connect to a terminal.
